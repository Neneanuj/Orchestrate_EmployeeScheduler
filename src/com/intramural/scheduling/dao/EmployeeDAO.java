...
public class EmployeeDAO {
    ...
    public void insert(Employee employee) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setInt(5, employee.isSupervisorEligible() ? 1 : 0);  // Use 1/0 for BIT
            stmt.setInt(6, employee.isActiveStatus() ? 1 : 0);  // Use 1/0 for BIT
    ...
    public void update(Employee employee) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setInt(4, employee.isSupervisorEligible() ? 1 : 0);  // Use 1/0 for BIT
            stmt.setInt(5, employee.isActiveStatus() ? 1 : 0);  // Use 1/0 for BIT
